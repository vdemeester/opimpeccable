...
import (
	...
	apisoperatorv1alpha1 "github.com/vdemeester/opimpeccable/pkg/apis/operator/v1alpha1"
	versioned "github.com/vdemeester/opimpeccable/pkg/client/clientset/versioned"
	v1alpha1 "github.com/vdemeester/opimpeccable/pkg/client/informers/externalversions/operator/v1alpha1"
	client "github.com/vdemeester/opimpeccable/pkg/client/injection/client"
	factory "github.com/vdemeester/opimpeccable/pkg/client/injection/informers/factory"
...
func Get(ctx context.Context) v1alpha1.OpenShiftPipelinesConfigInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/vdemeester/opimpeccable/pkg/client/informers/externalversions/operator/v1alpha1.OpenShiftPipelinesConfigInformer from context.")
	}
