...
import (
	...
	versionedscheme "github.com/vdemeester/opimpeccable/pkg/client/clientset/versioned/scheme"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	openshiftpipelinesconfigInformer := openshiftpipelinesconfig.Get(ctx)

	lister := openshiftpipelinesconfigInformer.Lister()
