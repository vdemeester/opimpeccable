...
import (
	...
	scheme "github.com/vdemeester/opimpeccable/pkg/client/clientset/versioned/scheme"
...
type OpenShiftPipelinesConfigInterface interface {
	Create(ctx context.Context, openShiftPipelinesConfig *v1alpha1.OpenShiftPipelinesConfig, opts v1.CreateOptions) (*v1alpha1.OpenShiftPipelinesConfig, error)
	Update(ctx context.Context, openShiftPipelinesConfig *v1alpha1.OpenShiftPipelinesConfig, opts v1.UpdateOptions) (*v1alpha1.OpenShiftPipelinesConfig, error)
	UpdateStatus(ctx context.Context, openShiftPipelinesConfig *v1alpha1.OpenShiftPipelinesConfig, opts v1.UpdateOptions) (*v1alpha1.OpenShiftPipelinesConfig, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.OpenShiftPipelinesConfig, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.OpenShiftPipelinesConfigList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpenShiftPipelinesConfig, err error)
	OpenShiftPipelinesConfigExpansion
}
...
func (c *openShiftPipelinesConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpenShiftPipelinesConfigList, err error) {
...
func (c *openShiftPipelinesConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *openShiftPipelinesConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
